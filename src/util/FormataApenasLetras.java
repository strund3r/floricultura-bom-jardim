...
public final class FormataApenasLetras extends JTextField{
    ...
    public FormataApenasLetras(int maximo) {
        super();
    ...
    private void jTextFieldKeyTyped(KeyEvent evt) {
        ...
        String caracteres = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ ";// lista de caracters que não devem ser aceitos
